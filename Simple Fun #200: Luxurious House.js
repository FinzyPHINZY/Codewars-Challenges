...
function luxhouse(houses) {
  ...
  return houses.map((house, i) => {
    const highest = Math.max(...houses.slice(i + 1), 0);

    return Math.max(0, highest - house + 1);

    // if (house > highest) {
    //   return 0;
    // } else {
    //   return highest - house + 1;
    // }
  });
}

console.log(luxhouse([1, 2, 3, 1, 2]), [3, 2, 0, 2, 0]);

console.log(luxhouse([3, 2, 1, 4]), [2, 3, 4, 0]);

console.log(luxhouse([2]), [0]);

console.log(luxhouse([1, 2, 3]), [3, 2, 0]);

console.log(luxhouse([3, 2, 1]), [0, 0, 0]);

console.log(luxhouse([1, 1, 1]), [1, 1, 0]);
