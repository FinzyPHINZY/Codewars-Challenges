...
// fn fill
// takes in two argument(arr, method = 0)
// returns arr.

// how to replace none?

// if method = -1 ? fill none with the closest value on the right.
// if method = 0? fill with the closest value on any side of the list
// if(method = 1? fill with the closest value on the left)
